        ...
        <form action="{{ !$course->id ? route('courses.store') : route('courses.update', ['slug' => $course->slug]) }}" 
            ...
            <div class="row justify-content-center">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <select name="category_id" id="category_id" class="form-control">
                                        @foreach (\App\Category::groupBy('name')->pluck('name', 'id') as $id => $category)
                                            <option {{ (int) old('category_id') === $id || $course->category_id === $id ? 'selected' : '' }} 
                            ...
                            <div class="form-group ml-3 mr-2">
                                <div class="col-md-6 offset-4">
                                    <input class="custom-file-input {{ $errors->has('picture') ? 'is-invalid' : '' }}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" 
                                        name="description" id="description" rows="8" required>{{ old('description') ?: $course->description }}
                                    </textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="requirement1" name="requirements[]"
                                        class="form-control {{ $errors->has('requirements.0') ? 'is-invalid' : '' }}" 
                                        value="{{ old('requirements.0') ? old('requirements.0') : 
                                        ($course->requirements_count > 0 ? $course->requirements[0]->requirement : '') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="requirement2" name="requirements[]"
                                        class="form-control {{ $errors->has('requirements.1')? 'is-invalid' : '' }}" 
                                        value="{{ old('requirements.1') ? old('requirements.1') : 
                                        ($course->requirements_count > 1 ? $course->requirements[1]->requirement : '') }}">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            {{ __("¿Qué conseguirá el estudiante al finalizar el curso ?") }}
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="goal1" name="goals[]"
                                        class="form-control {{ $errors->has('goals.0')? 'is-invalid' : '' }}" 
                                        value="{{ old('goals.0') ? old('goals.0') : 
                                        ($course->goals_count > 0 ? $course->goals[0]->goal : '') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="goal2" name="goals[]"
                                        class="form-control {{ $errors->has('goals.1')? 'is-invalid' : '' }}" 
                                        value="{{ old('goals.1') ? old('goals.1') : 
                                        ($course->goals_count > 1 ? $course->goals[1]->goal : '') }}">
