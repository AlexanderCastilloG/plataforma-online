...
Route::get('/images/{path}/{attachment}', function($path, $attachment){
    ...
    // Comprobamos si existe el archivo, utilizando un path
    if(File::exists($file)){
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'subscriptions'], function () {
        ...
        Route::post('/resume', 'SubscriptionController@resumen')->name('subscriptions.resume');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', sprintf("role:%s", \App\Role::ADMIN)]], function () {
    ...
    Route::post('/courses/updateStatus', 'AdminController@updateCourseStatus'); //Petición a través de VUE-HTTP-RESOURCE

    ////
    Route::get('/students', 'AdminController@students')->name('admin.students');
    Route::get('/student_json', 'AdminController@studentsJson')->name('admin.students_json');
